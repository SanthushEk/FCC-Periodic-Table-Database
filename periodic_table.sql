...
--
-- Name: properties fk_property_types; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_property_types FOREIGN KEY (type_id) REFERENCES public.types(type_id);
